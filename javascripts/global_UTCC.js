...
\**************************************************************************************************************/
//Jordan, do not change this menu.  If you do, I will drive my fat, white ass down there and beat the shit out of you.  ^_^
var UTCC = {
			/*canSave : can_save,
								...
								<div class='textFrameT'><div class='textFrameL'><div class='textFrameR'>\
									<div class='textFramed'>\
										...
										<div id='UTCC_AUgraphic'>\
											<label for='UTCC_AUgraphicNum'>Rank: </label><select id='UTCC_AUgraphicNum'>\
														<option>1</option>\
														<option>2</option>\
														<option>3</option>\
														<option>4</option>\
								...
								<div class='textFrameT'><div class='textFrameL'><div class='textFrameR'>\
									<div class='textFramed'>\
										<div id='UTCC_unitDescBox'>\
											<img src='AIFrames/units/soldierrenderSMALL.png' id='UTCC_AUpic' />\
											<img src='AIFrames/units/insig1.png' id='UTCC_RankPic' class='lightFrameBody'/>\
